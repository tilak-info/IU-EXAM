<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="Add_Student.aspx.cs" Inherits="Admin_Add_Student" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="card-header">
                        <strong>Add Student</strong> Detail
                      </div>
                      <div class="card-body card-block">
                        <form action="processing page" method="post" enctype="multipart/form-data"   class="form-horizontal">
                            ...
                            <div class="col col-md-3"><label class=" form-control-label" for="text-input" class=" form-control-label">Student Enrollment</label></div>
                             <div class="col-12 col-md-9"> <asp:TextBox ID="TextBox1" runat="server" CssClass="form-control" ></asp:TextBox>  
                                 ...
                                 <div class="col col-md-3"><label for="text-input" class=" form-control-label">Student Name</div>
                              ...
                              <div class="col-12 col-md-9"> <asp:DropDownList ID="DropDownList1" CssClass="form-control" runat="server" DataSourceID="dept" DataTextField="dept_name" DataValueField="dept_name">
